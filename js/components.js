...
(function () {
    ...
    var headerHTML = ''
        ...
        +             '<li><a href="/fire-restoration-auckland">Fire Restoration</a></li>'
        +             '<li><a href="/mould-removal-auckland">Mould Removal</a></li>'
        +             '<li><a href="/meth-cleanup-auckland">Meth Cleanup</a></li>'
        +             '<li><a href="/biohazard-cleaning-decontamination-service-in-auckland">Biohazard Cleaning</a></li>'
        +           '</ul>'
        +         '</li>'
        +         '<li><a href="/areas-we-serve" class="nav-link">Areas We Serve</a></li>'
        +         '<li><a href="/about" class="nav-link">About</a></li>'
        +         '<li><a href="/blog" class="nav-link">Blog</a></li>'
        +         '<li><a href="/our-projects" class="nav-link">Our Projects</a></li>'
